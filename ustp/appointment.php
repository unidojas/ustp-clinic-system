...
if(isset($_POST[submit]))
{
		...
		{
			$sql ="UPDATE appointment SET patientid='$_POST[select4]', appointmentdate='$_POST[appointmentdate]',appointmenttime='$_POST[time]',doctorid='$_POST[select6]',status='$_POST[select]', app_reason='$_POST[appreason]' WHERE appointmentid='$_GET[editid]'";
		...
		else
		{
			...
			$sql ="INSERT INTO appointment(patientid,appointmentdate, appointmenttime, doctorid, status, app_reason) values('$_POST[select4]','$_POST[appointmentdate]','$_POST[time]','$_POST[select6]','$_POST[select]','$_POST[appreason]')";
			if($qsql = mysqli_query($con,$sql))
			{
