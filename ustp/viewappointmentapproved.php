...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      <li class="first">Approved Appointment Records</li></ul>
  </div>
</div>
...
<h2>Search Approved Appointment - <input type="search" class="light-table-filter" data-table="order-table" placeholder="Filter" /></h2>
    ...
    linear-gradient(rgba(0,0,0,0.40),rgba(0,0,0,0.40)),url(./images/3.png); font-weight: bold;">
      <thead>
        <tr>
          ...
          <th width="20%">Appointment Reason</th>
          <th>Status</th>
