...
<div class="wrapper col2">
  <div id="breadcrumb">
  <ul>
      <li class="first">Admin Login Portal</li>
	</ul>  
  </div>
</div>
<div class="wrapper col4">
  <div id="container">
    ...
    <table width="200" border="3" style="background-image: 
    linear-gradient(rgba(0,0,0,0.40),rgba(0,0,0,0.40)),url(./images/login-bg.png);">
      <tbody>
        <tr>
          <td width="34%"><b>Login ID</td>
