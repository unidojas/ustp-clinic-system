...
<div id="mmenu">
    ...
    <a href=" ######### ">Treatment</a>
        <ul>
            <li><a href="treatment.php" style="width:200px;">Add Treatment type</a></li>
           <li><a href="viewtreatmentrecord.php" style="width:200px;">View Treatment Records</a></li>
            <li><a href="viewtreatment.php" style="width:200px;">View Treatment</a></li>
        </ul>
    </li>   
...
<a href=" ######### ">Appointment</a>
    <ul>
    <li><a href="patientappointment.php" style="width:150px;">Add Appointment</a></li>
    <li><a href="viewappointment.php" style="width:150px;">View Appointments</a></li>
    </ul>
</li>
<li>
<a href=" ######### ">Profile</a>
...
<a href=" ######### ">Prescription</a>
    <ul >
       <li><a style="width:180px;" href="patviewprescription.php">View Prescription Records</a></li>
    </ul>
</li>
<li>
<a href=" ######### ">Treatment</a>
    <ul>
       <li><a href="viewtreatmentrecord.php" style="width:180px;">View Treatment Records</a></li>
    </ul>
</li>
